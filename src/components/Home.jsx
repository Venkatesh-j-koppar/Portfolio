    ...
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full md:flex-row text-white">
        <div className="flex flex-col justify-center items-start px-4 m-8">
          ...
          <div>
            <button className="group text-white w-fit px-6 py-3 my-2 flex justify-center items-center rounded-md bg-gradient-to-r mx-auto w-2/3 md:w-full from-cyan-500 to-blue-500 text-xl">
              Portfolio
